...
public class TransactionBuilder
{
    ...
    public TransactionBuilder(AElfClient aelfClient)
    {
        ...
        PrivateKey = ByteArrayHelper.HexStringToByteArray(AElfWebServerConstants.DefaultPrivateKey);
    }
    ...
    public Transaction Build()
    {
        ...
        var signedTx = _aelfClient.SignTransaction(PrivateKey.ToHex(), unsignedTx);
        return signedTx;
    }
}